...
namespace VidyoClient
{
	public class Endpoint{
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoEndpointSetCameraNudgeConfigurationNative(IntPtr e, [MarshalAs(UnmanagedType.LPStr)]String cameraNudgeConfig);
		...
		public Boolean SetCameraNudgeConfiguration(String cameraNudgeConfig){
			...
			Boolean ret = VidyoEndpointSetCameraNudgeConfigurationNative(objPtr, cameraNudgeConfig);
